...
- Always finish your editing sessions with a `cargo check` to ensure that everything is working correctly. This will help catch any errors or issues before they become a problem.
